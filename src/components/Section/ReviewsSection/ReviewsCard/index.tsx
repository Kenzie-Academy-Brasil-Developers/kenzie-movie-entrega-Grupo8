...
export const ReviewsCard = ({ review }: { review: IReview }) => {
  ...
  return (
    ...
    <ul className="my-[10px] mx-[1px] flex-initial w-[275px] min-h-[510px]  sm:w-[390px] md:min-h-[510px] 
    h-max  gap-6 flex-col flex items-center flex-wrap  focus:border-yellow-600   hover:shadow-lg hover:shadow-yellow-600 ">
